...
def DisplayErrorPlot(train_error_list, valid_error_list):
  plt.figure(1)
  plt.clf()
  plt.plot(range(len(train_error_list[0])), train_error_list[0], label='Train_2')
  plt.plot(range(len(valid_error_list[0])), valid_error_list[0], label='Validation_2')
  plt.plot(range(len(train_error_list[1])), train_error_list[1], label='Train_5')
  plt.plot(range(len(valid_error_list[1])), valid_error_list[1], label='Validation_5')
  plt.plot(range(len(train_error_list[2])), train_error_list[2], label='Train_30')
  plt.plot(range(len(valid_error_list[2])), valid_error_list[2], label='Validation_30')
  plt.plot(range(len(train_error_list[3])), train_error_list[3], label='Train_100')
  plt.plot(range(len(valid_error_list[3])), valid_error_list[3], label='Validation_100')
  plt.xlabel('Epochs')
...
def main():
  ...
  train_error_list.append(train_error)
  valid_error_list.append(valid_error)
  DisplayErrorPlot(train_error_list, valid_error_list)
